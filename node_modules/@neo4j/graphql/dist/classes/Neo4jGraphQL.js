...
class Neo4jGraphQL {
    ...
    createWrappedSchema({ schema, config, }) {
        return schema_1.addSchemaLevelResolver(schema, (obj, _args, context, resolveInfo) => __awaiter(this, void 0, void 0, function* () {
            ...
            */
            ...
            if (!context.jwt) {
                context.jwt = yield auth_1.getJWT(context);
            }
    ...
    assertIndexesAndConstraints(input = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield asserts_indexes_and_constraints_1.default({ driver, driverConfig, nodes: this.nodes, options: input.options });
        });
    }
}
