...
function getObjFieldMeta({ obj, objects, interfaces, scalars, unions, enums, }) {
    ...
    return (_a = obj === null || obj === void 0 ? void 0 : obj.fields) === null || _a === void 0 ? void 0 : _a.reduce((res, field) => {
        ...
        const baseField = Object.assign(Object.assign(Object.assign({ fieldName: field.name.value, dbPropertyName: field.name.value, typeMeta, otherDirectives: (field.directives || []).filter((x) => ![
                "relationship",
                "cypher",
                "id",
                "auth",
                ...
                "alias",
                "unique",
            ].includes(x.name.value)), arguments: [...(field.arguments || [])] }, (authDirective ? { auth: get_auth_1.default(authDirective) } : {})), { description: (_c = field.description) === null || _c === void 0 ? void 0 : _c.value, readonly: directives.some((d) => d.name.value === "readonly") || ((_d = interfaceField === null || interfaceField === void 0 ? void 0 : interfaceField.directives) === null || _d === void 0 ? void 0 : _d.some((x) => x.name.value === "readonly")), writeonly: directives.some((d) => d.name.value === "writeonly") || ((_e = interfaceField === null || interfaceField === void 0 ? void 0 : interfaceField.directives) === null || _e === void 0 ? void 0 : _e.some((x) => x.name.value === "writeonly")) }), (unique ? { unique } : {}));
        if (aliasDirective) {
        ...
        if (relationshipMeta) {
            ...
            const relationField = Object.assign(Object.assign(Object.assign({}, baseField), relationshipMeta), { inherited: false });
            if (fieldUnion) {
                const nodes = [];
            ...
            if (fieldInterface) {
                const implementations = objects
                    ...
                    .map((n) => n.name.value);
                relationField.interface = Object.assign(Object.assign({}, baseField), { implementations });
            }
            ...
            res.interfaceFields.push(Object.assign({}, baseField));
        }
        else if (fieldObject) {
            if (defaultDirective) {
                throw new Error("@default directive can only be used on primitive type fields");
