...
function makeAugmentedSchema(_a, { enableRegex, skipValidateTypeDefs } = {}) {
    ...
    const nodes = objectNodes.map((definition) => {
        ...
        const node = new classes_1.Node(Object.assign(Object.assign({ name: definition.name.value, interfaces: nodeInterfaces, otherDirectives }, nodeFields), { 
            ...
            nodeDirective,
            // @ts-ignore we can be sure it's defined
            fulltextDirective, description: (_a = definition.description) === null || _a === void 0 ? void 0 : _a.value }));
        return node;
    });
    ...
    interfaceRelationships.forEach((interfaceRelationship) => {
        ...
        composer.createInputTC({
            ...
            fields: Object.assign(Object.assign({}, interfaceWhereFields), { _on: implementationsWhereInput }),
        });
        ...
        composer.getOrCreateITC(`${interfaceRelationship.name.value}UpdateInput`, (tc) => {
            tc.addFields(Object.assign(Object.assign({}, [
    ...
    unions.forEach((union) => {
        if (union.types && union.types.length) {
            const fields = union.types.reduce((f, type) => {
                return Object.assign(Object.assign({}, f), { [type.name.value]: `${type.name.value}Where` });
            }, {});
            composer.createInputTC({
    ...
    nodes.forEach((node) => {
        ...
        const sortFields = node.sortableFields.reduce((res, f) => (Object.assign(Object.assign({}, res), { [f.fieldName]: sortDirection.getTypeName() })), {});
        ...
        composer.createObjectTC({
            ...
            fields: Object.assign({ count: countField }, [...node.primitiveFields, ...node.temporalFields].reduce((res, field) => {
        ...
        if (node.fulltextDirective) {
            const fields = node.fulltextDirective.indexes.reduce((res, index) => {
                return Object.assign(Object.assign({}, res), { [index.name]: composer.createInputTC({
