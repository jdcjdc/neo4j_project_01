...
function createResolver({ node }) {
    function resolve(_root, _args, _context, info) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Object.assign({ info: Object.assign({ bookmark: executeResult.bookmark }, executeResult.statistics) }, (nodeProjection ? { [nodeKey]: Object.values(executeResult.records[0] || {}) } : {}));
        });
    }
    return {
