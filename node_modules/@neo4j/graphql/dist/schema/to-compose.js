...
exports.objectFieldsToComposeFields = exports.graphqlDirectivesToCompose = exports.graphqlArgsToCompose = void 0;
...
function graphqlArgsToCompose(args) {
    return args.reduce((res, arg) => {
        const meta = get_field_type_meta_1.default(arg);
        return Object.assign(Object.assign({}, res), { [arg.name.value]: Object.assign({ type: meta.pretty, description: arg.description }, (arg.defaultValue ? { defaultValue: parse_value_node_1.default(arg.defaultValue) } : {})) });
    }, {});
}
...
function graphqlDirectivesToCompose(directives) {
    return directives.map((directive) => {
        var _a;
        return ({
            args: (_a = (directive.arguments || [])) === null || _a === void 0 ? void 0 : _a.reduce((r, d) => (Object.assign(Object.assign({}, r), { [d.name.value]: parse_value_node_1.default(d.value) })), {}),
...
function objectFieldsToComposeFields(fields) {
    return fields.reduce((res, field) => {
        ...
        return Object.assign(Object.assign({}, res), { [field.fieldName]: newField });
    }, {});
}
