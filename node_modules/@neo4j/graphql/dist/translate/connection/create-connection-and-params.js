...
function createConnectionAndParams({ resolveTree, field, context, nodeVariable, parameterPrefix, }) {
    ...
    if (field.relationship.union || field.relationship.interface) {
        const relatedNodes = field.relationship.union
            ? context.neoSchema.nodes.filter((n) => { var _a, _b; return (_b = (_a = field.relationship.union) === null || _a === void 0 ? void 0 : _a.nodes) === null || _b === void 0 ? void 0 : _b.includes(n.name); })
            : context.neoSchema.nodes.filter((x) => {
                var _a, _b, _c;
                return ((_c = (_b = (_a = field.relationship) === null || _a === void 0 ? void 0 : _a.interface) === null || _b === void 0 ? void 0 : _b.implementations) === null || _c === void 0 ? void 0 : _c.includes(x.name)) &&
                    filter_interface_nodes_1.default({ node: x, whereInput: whereInput === null || whereInput === void 0 ? void 0 : whereInput.node });
            });
        const subqueries = [];
        ...
        if (sortInput && sortInput.length) {
            const sort = sortInput.map((s) => Object.entries(s.edge || []).map(([f, direction]) => `edge.${f} ${direction}`).join(", "));
