...
function createConnectAndParams({ withVars, value, varName, relationField, parentVar, refNodes, context, labelOverride, parentNode, fromCreate, insideDoWhen, }) {
    function createSubqueryContents(relatedNode, connect, index) {
        ...
        if (connect.where) {
            ...
            const rootNodeWhereAndParams = create_where_and_params_1.default({
                whereInput: Object.assign({}, Object.entries(connect.where.node).reduce((args, [k, v]) => {
                    var _a, _b, _c;
                    if (k !== "_on") {
                        ...
                        return Object.assign(Object.assign({}, args), { [k]: v });
                    }
                    return args;
                }, {})),
                context,
            ...
            if (rootNodeWhereAndParams[0]) {
                ...
                params = Object.assign(Object.assign({}, params), rootNodeWhereAndParams[1]);
            }
            // For _on filters
            if ((_b = (_a = connect.where.node) === null || _a === void 0 ? void 0 : _a._on) === null || _b === void 0 ? void 0 : _b[relatedNode.name]) {
                const onTypeNodeWhereAndParams = create_where_and_params_1.default({
                    whereInput: Object.assign({}, Object.entries(connect.where.node).reduce((args, [k, v]) => {
                        if (k !== "_on") {
                            return Object.assign(Object.assign({}, args), { [k]: v });
                        }
                        if (Object.prototype.hasOwnProperty.call(v, relatedNode.name)) {
                            return Object.assign(Object.assign({}, args), v[relatedNode.name]);
                        }
                        return args;
                    }, {})),
                    context,
                ...
                if (onTypeNodeWhereAndParams[0]) {
                    ...
                    params = Object.assign(Object.assign({}, params), onTypeNodeWhereAndParams[1]);
                }
            }
        }
        if (relatedNode.auth) {
        ...
        const preAuth = [...(!fromCreate ? [parentNode] : []), relatedNode].reduce((result, node, i) => {
            ...
            const [str, p] = create_auth_and_params_1.default({
                entity: node,
                operations: "CONNECT",
                context,
            ...
            result.params = Object.assign(Object.assign({}, result.params), p);
            return result;
        }, { connects: [], params: {} });
        if (preAuth.connects.length) {
            ...
            params = Object.assign(Object.assign({}, params), preAuth.params);
        }
        /*
           TODO
        ...
        */
        ...
        if (relationField.properties) {
            ...
            params = Object.assign(Object.assign({}, params), setA[1]);
        }
        ...
        if (connect.connect) {
            ...
            connects.forEach((c) => {
                ...
                params = Object.assign(Object.assign({}, params), reduced.params);
                if (relationField.interface && ((_a = c === null || c === void 0 ? void 0 : c._on) === null || _a === void 0 ? void 0 : _a[relatedNode.name])) {
                    ...
                    onConnects.forEach((onConnect, onConnectIndex) => {
                        ...
                        params = Object.assign(Object.assign({}, params), onReduced.params);
                    });
                }
            });
        }
        ...
        if (postAuth.connects.length) {
            ...
            params = Object.assign(Object.assign({}, params), postAuth.params);
        }
        ...
        if (relationField.interface) {
            ...
            refNodes.forEach((refNode) => {
                ...
                if (subquery.subquery) {
                    ...
                    res.params = Object.assign(Object.assign({}, res.params), subquery.params);
                }
            });
