...
const create_node_where_and_params_1 = __importDefault(require("./where/create-node-where-and-params"));
function createInterfaceProjectionAndParams({ resolveTree, field, context, node, nodeVariable, parameterPrefix, }) {
    ...
    const referenceNodes = context.neoSchema.nodes.filter((x) => { var _a, _b; return ((_b = (_a = field.interface) === null || _a === void 0 ? void 0 : _a.implementations) === null || _b === void 0 ? void 0 : _b.includes(x.name)) && filter_interface_nodes_1.default({ node: x, whereInput }); });
    let whereArgs = {};
    const subqueries = referenceNodes.map((refNode) => {
        ...
        if (resolveTree.args.where) {
            // For root filters
            const rootNodeWhereAndParams = create_node_where_and_params_1.default({
                whereInput: Object.assign({}, Object.entries(whereInput).reduce((args, [k, v]) => {
                    var _a, _b;
                    if (k !== "_on") {
            ...
            if (rootNodeWhereAndParams[0]) {
                ...
                whereArgs = Object.assign(Object.assign({}, whereArgs), rootNodeWhereAndParams[1]);
            }
            // For _on filters
            if ((_a = whereInput === null || whereInput === void 0 ? void 0 : whereInput._on) === null || _a === void 0 ? void 0 : _a[refNode.name]) {
                const onTypeNodeWhereAndParams = create_node_where_and_params_1.default({
                    whereInput: Object.assign({}, Object.entries(whereInput).reduce((args, [k, v]) => {
                        if (k !== "_on") {
                            return Object.assign(Object.assign({}, args), { [k]: v });
                        }
                        if (Object.prototype.hasOwnProperty.call(v, refNode.name)) {
                            return Object.assign(Object.assign({}, args), v[refNode.name]);
                        }
                        return args;
                    }, {})),
                    context,
        ...
        if ((_c = (_b = recurse[2]) === null || _b === void 0 ? void 0 : _b.connectionFields) === null || _c === void 0 ? void 0 : _c.length) {
            recurse[2].connectionFields.forEach((connectionResolveTree) => {
                ...
                params = Object.assign(Object.assign({}, params), connection[1]);
            });
        }
        if ((_e = (_d = recurse[2]) === null || _d === void 0 ? void 0 : _d.interfaceFields) === null || _e === void 0 ? void 0 : _e.length) {
            recurse[2].interfaceFields.forEach((interfaceResolveTree) => {
                ...
                params = Object.assign(Object.assign({}, params), interfaceProjection.params);
            });
        }
        subquery.push(`RETURN ${recurse[0]} AS ${field.fieldName}`);
        globalParams = Object.assign(Object.assign({}, globalParams), recurse[1]);
    ...
    return {
        ...
        params: Object.assign(Object.assign({}, globalParams), (Object.keys(params).length ? { [`${nodeVariable}_${resolveTree.alias}`]: params } : {})),
    };
}
