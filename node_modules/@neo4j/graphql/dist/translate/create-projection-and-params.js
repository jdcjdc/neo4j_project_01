...
function createProjectionAndParams({ fieldsByTypeName, node, context, chainStr, varName, literalElements, resolveType, inRelationshipProjection, }) {
    ...
    function reducer(res, [key, field]) {
        ...
        if (cypherField) {
            ...
            const unions = context.neoSchema.document.definitions.filter((x) => x.kind === "UnionTypeDefinition");
            ...
            if (referenceNode) {
                ...
                projectionStr = str;
                res.params = Object.assign(Object.assign({}, res.params), p);
            ...
            if (referenceUnion) {
                const headStrs = [];
                const referencedNodes = ((_e = (_d = (_c = referenceUnion === null || referenceUnion === void 0 ? void 0 : referenceUnion.types) === null || _c === void 0 ? void 0 : _c.map((u) => context.neoSchema.nodes.find((n) => n.name === u.name.value))) === null || _d === void 0 ? void 0 : _d.filter((b) => b !== undefined)) === null || _e === void 0 ? void 0 : _e.filter((n) => { var _a; return Object.keys(fieldFields).includes((_a = n === null || n === void 0 ? void 0 : n.name) !== null && _a !== void 0 ? _a : ""); })) || [];
            ...
            const apocStr = `${!isPrimitive && !isEnum && !isScalar ? `${param} IN` : ""} apoc.cypher.runFirstColumn("${cypherField.statement}", ${apocParamsStr}, ${expectMultipleValues})${apocWhere ? ` ${apocWhere}` : ""}${unionWhere ? ` ${unionWhere} ` : ""}${projectionStr ? ` | ${!referenceUnion ? param : ""} ${projectionStr}` : ""}`;
        ...
        if (relationField) {
            ...
            if (relationField.interface) {
                ...
                let offsetLimitStr = "";
                if (optionsInput) {
                    offsetLimitStr = pagination_1.createOffsetLimitStr({ offset: optionsInput.offset, limit: optionsInput.limit });
                }
        ...
        const aggregationFieldProjection = create_field_aggregation_1.createFieldAggregation({
            context,
        ...
        if (aggregationFieldProjection) {
            ...
            res.params = Object.assign(Object.assign({}, res.params), aggregationFieldProjection.params);
            return res;
        }
        if (connectionField) {
        ...
        if (pointField) {
            ...
            res.projection.push(create_datetime_element_1.createDatetimeElement({ resolveTree: field, field: temporalField, variable: varName }));
        }
        else {
