            ...
            refNodes.forEach((refNode) => {
                ...
                updates.forEach((update, index) => {
                    ...
                    if (update.update) {
                        ...
                        if (update.update.node) {
                            ...
                            const nestedUpdateInput = Object.entries(update.update.node)
                                ...
                                .reduce((d1, [k1, v1]) => (Object.assign(Object.assign({}, d1), { [k1]: v1 })), {});
                            ...
                            if (relationField.interface && ((_b = (_a = update.update.node) === null || _a === void 0 ? void 0 : _a._on) === null || _b === void 0 ? void 0 : _b[refNode.name])) {
                                ...
                                res.params = Object.assign(Object.assign(Object.assign({}, res.params), onUpdateAndParams[1]), { auth });
                                innerApocParams = Object.assign(Object.assign({}, innerApocParams), onUpdateAndParams[1]);
                    ...
                    if (update.connectOrCreate) {
                        const [connectOrCreateQuery, connectOrCreateParams] = create_connect_or_create_and_params_1.createConnectOrCreateAndParams({
                        ...
                        subquery.push(wrap_in_call_1.wrapInCall(connectOrCreateQuery, varName));
                        res.params = Object.assign(Object.assign({}, res.params), connectOrCreateParams);
                    }
                    if (update.delete) {
