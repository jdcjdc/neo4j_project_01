...
function buildRelationStatement({ leftNode, rightNode, context, relation, }) {
    ...
    const leftNodeStatement = build_node_statement_1.buildNodeStatement(Object.assign({ context }, leftNode));
    const rightNodeStatement = build_node_statement_1.buildNodeStatement(Object.assign({ context }, rightNode));
