...
function createFieldAggregationAuth({ node, context, subqueryNodeAlias, nodeFields, }) {
    ...
    const cypherParams = Object.assign(Object.assign(Object.assign({}, nodeAuth.params), allowAuth.params), whereAuth.params);
    ...
    Object.entries(fields).forEach((selection) => {
        ...
        if (authField && authField.auth) {
            ...
            if (allowAndParams[0]) {
                ...
                authParams = Object.assign(Object.assign({}, authParams), allowAndParams[1]);
            }
        }
    });
