...
function translateCreate({ context, node }) {
    ...
    let interfaceParams;
    const mutationResponse = resolveTree.fieldsByTypeName[`Create${node.getPlural({ camelCase: false })}MutationResponse`];
    ...
    if (nodeProjection) {
        ...
        if ((_f = (_e = projection[2]) === null || _e === void 0 ? void 0 : _e.interfaceFields) === null || _f === void 0 ? void 0 : _f.length) {
            projection[2].interfaceFields.forEach((interfaceResolveTree) => {
                ...
                if (!interfaceParams)
                    interfaceParams = {};
                interfaceParams = Object.assign(Object.assign({}, interfaceParams), interfaceProjection.params);
            });
        }
    }
    ...
    const replacedInterfaceParams = interfaceParams
        ? createStrs.reduce((res1, _, i) => {
            return Object.assign(Object.assign({}, res1), Object.entries(interfaceParams).reduce((res2, [key, value]) => {
                return Object.assign(Object.assign({}, res2), { [key.replace("REPLACE_ME", `this${i}`)]: value });
            }, {}));
        }, {})
        : {};
    ...
    return [
        ...
        Object.assign(Object.assign(Object.assign(Object.assign({}, params), replacedProjectionParams), replacedConnectionParams), replacedInterfaceParams),
    ];
}
