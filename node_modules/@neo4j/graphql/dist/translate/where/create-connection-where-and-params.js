...
function createConnectionWhereAndParams({ whereInput, context, node, nodeVariable, relationship, relationshipVariable, parameterPrefix, }) {
    const reduced = Object.entries(whereInput).reduce((res, [k, v]) => {
        ...
        if (k.startsWith("node") || k.startsWith(node.name)) {
            ...
            const rootNodeWhere = create_node_where_and_params_1.default({
                whereInput: Object.assign({}, Object.entries(v).reduce((args, [key, value]) => {
                    var _a, _b;
                    if (key !== "_on") {
                        if ((_b = (_a = v === null || v === void 0 ? void 0 : v._on) === null || _a === void 0 ? void 0 : _a[node.name]) === null || _b === void 0 ? void 0 : _b[key]) {
                            return args;
                        }
                        return Object.assign(Object.assign({}, args), { [key]: value });
                    }
                    return args;
                }, {})),
                node,
            ...
            if (rootNodeWhere[0]) {
                ...
                params = Object.assign(Object.assign({}, params), { [k]: rootNodeWhere[1] });
                res = { whereStrs, params };
            }
            if ((_a = v === null || v === void 0 ? void 0 : v._on) === null || _a === void 0 ? void 0 : _a[node.name]) {
                const onTypeNodeWhere = create_node_where_and_params_1.default({
                    whereInput: Object.assign({}, Object.entries(v).reduce((args, [key, value]) => {
                        if (key !== "_on") {
                            return Object.assign(Object.assign({}, args), { [key]: value });
                        }
                        if (Object.prototype.hasOwnProperty.call(value, node.name)) {
                            return Object.assign(Object.assign({}, args), value[node.name]);
                        }
                        return args;
                    }, {})),
                    node,
                ...
                params = Object.assign(Object.assign({}, params), { [k]: onTypeNodeWhere[1] });
                res = { whereStrs, params };
            }
        }
        return res;
