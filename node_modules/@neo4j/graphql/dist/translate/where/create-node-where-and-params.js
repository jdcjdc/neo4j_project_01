        ...
        if (!operator) {
            ...
            if (relationField) {
                ...
                let resultStr = [
                    ...
                    `AND ${not ? "NONE" : "ANY"}(${relatedNodeVariable} IN [(${nodeVariable})${inStr}${relTypeStr}${outStr}(${relatedNodeVariable}:${relationField.typeMeta.name}) | ${relatedNodeVariable}] INNER_WHERE `,
                ].join(" ");
                const recurse = createNodeWhereAndParams({
                    whereInput: value,
                    node: refNode,
                ...
                res.params = Object.assign(Object.assign({}, res.params), { fieldName: recurse[1] });
                return res;
            }
            if (value === null) {
