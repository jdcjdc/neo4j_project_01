...
function createRelationshipWhereAndParams({ whereInput, context, relationship, relationshipVariable, parameterPrefix, }) {
    ...
    function reducer(res, [key, value]) {
        ...
        const fieldName = (_a = match === null || match === void 0 ? void 0 : match.groups) === null || _a === void 0 ? void 0 : _a.field;
        const not = !!((_b = match === null || match === void 0 ? void 0 : match.groups) === null || _b === void 0 ? void 0 : _b.not);
        const operator = (_c = match === null || match === void 0 ? void 0 : match.groups) === null || _c === void 0 ? void 0 : _c.operator;
        ...
        const durationField = relationship.primitiveFields.find((f) => f.fieldName === fieldName && f.typeMeta.name === "Duration");
        const coalesceValue = (_d = [
            ...relationship.temporalFields,
            ...relationship.enumFields,
            ...relationship.scalarFields,
            ...relationship.primitiveFields,
        ].find((f) => f.fieldName === fieldName && "coalesce" in f)) === null || _d === void 0 ? void 0 : _d.coalesceValue;
        ...
        if (fieldName && ["AND", "OR"].includes(fieldName)) {
            ...
            res.params = Object.assign(Object.assign({}, res.params), { [fieldName]: nestedParams });
            return res;
        }
        // Equality/inequality
        if (!operator) {
...
exports.default = createRelationshipWhereAndParams;
//# sourceMappingURL=create-relationship-where-and-params.js.map