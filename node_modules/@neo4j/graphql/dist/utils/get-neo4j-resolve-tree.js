...
function getNeo4jResolveTree(resolveInfo, options) {
    ...
    if (options === null || options === void 0 ? void 0 : options.field) {
        ...
        field = Object.values(Object.assign(Object.assign(Object.assign({}, queryType === null || queryType === void 0 ? void 0 : queryType.getFields()), mutationType === null || mutationType === void 0 ? void 0 : mutationType.getFields()), subscriptionType === null || subscriptionType === void 0 ? void 0 : subscriptionType.getFields())).find((f) => f.name === resolveTree.name);
    }
